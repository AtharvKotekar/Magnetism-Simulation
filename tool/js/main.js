...
import { createGL } from './render/gl.js?v=well-v3';
import { SceneLayers } from './render/scene.js?v=well-v3';
import { FilingRenderer, FLOATS_PER } from './render/filings.js?v=well-v3';
import { Overlays } from './render/overlays.js?v=well-v3';
import { Homography, loadCalibration, saveCalibration } from './render/homography.js';
import { CalibrationUI } from './ui/calibration.js?v=well-v3';
import { buildPanel, diagnosticsHTML } from './ui/panel.js?v=well-v3';
import { TimelineUI } from './ui/timelineui.js';
import { PRESETS } from './ui/presets.js?v=well-v3';
import { DEFAULT_UI } from './ui/defaults.js?v=well-v3';
import { Recorder } from './record/recorder.js';
import { DEFAULT_PARAMS } from './sim/units.js';
import { buildVariantConfig } from './variant.js?v=well-v3';
import { CompassOverlay } from './render/compass.js?v=well-v3';
...
async function boot() {
  ...
  // worker
  app.worker = new Worker(new URL('./sim/worker.js?v=well-v3', import.meta.url), { type: 'module' });
