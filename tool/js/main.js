...
import { createGL } from './render/gl.js?v=coil-v57';
import { SceneLayers } from './render/scene.js?v=coil-v57';
import { FilingRenderer, FLOATS_PER } from './render/filings.js?v=coil-v57';
import { Overlays } from './render/overlays.js?v=coil-v57';
import { Homography, loadCalibration, saveCalibration } from './render/homography.js';
import { CalibrationUI } from './ui/calibration.js?v=coil-v57';
import { buildPanel, diagnosticsHTML } from './ui/panel.js?v=coil-v57';
import { TimelineUI } from './ui/timelineui.js';
import { PRESETS } from './ui/presets.js?v=coil-v57';
import { DEFAULT_UI } from './ui/defaults.js?v=coil-v57';
import { Recorder } from './record/recorder.js';
import { DEFAULT_PARAMS } from './sim/units.js';
import { buildVariantConfig } from './variant.js?v=coil-v57';
import { CompassOverlay } from './render/compass.js?v=coil-v57';
...
async function boot() {
  ...
  // worker
  app.worker = new Worker(new URL('./sim/worker.js?v=coil-v57', import.meta.url), { type: 'module' });
